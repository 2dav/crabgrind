...
This modifies the thread-local DRD state. It applies to **all** read operations
...
Common use cases include benign races in lock-free algorithms or debugging noisy
output from known-safe racy reads.
