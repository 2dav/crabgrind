...
accesses performed after this call as happening-after all accesses performed
before the corresponding `_BEFORE` call in other threads.

This must be called **immediately after** the real synchronization action
succeeds (e.g., after returning from a wait on a semaphore or observing a flag).
