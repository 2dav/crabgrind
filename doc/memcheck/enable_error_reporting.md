...
within the specified range after it has been disabled via [`disable_error_reporting`].

This only affects the reporting of addressing errors (A-bits). Undefined
