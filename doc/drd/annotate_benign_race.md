...
- Lock-free algorithms utilizing atomic CPU instructions (outside of Rust's
  [`std::sync::atomic`][std-atomic]).
...
See also [`annotate_benign_race_sized`](annotate_benign_race_sized) for raw byte
ranges.
