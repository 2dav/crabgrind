...
This is required for cleanup logic. Calling this ensures that Helgrind does not
hold internal resources indefinitely for a synchronization object that is no
longer in use or is being recycled.
