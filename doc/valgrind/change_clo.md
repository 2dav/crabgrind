...
Valgrind validates the option string at runtime. If the option is unknown, does
not support dynamic changes, or is syntactically incorrect, Valgrind outputs a
