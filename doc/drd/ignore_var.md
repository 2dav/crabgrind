...
This corresponds to the `DRD_IGNORE_VAR` and `DRD_STOP_IGNORING_VAR` client
requests.
...
involving intentional races (e.g., benign duplicate writes from multiple
threads) where modifying synchronization logic is impractical.
